                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="px-2 py-1 rounded-full bg-green-700 hover:bg-green-800 text-xs text-neutral-100 cursor-pointer">Follow</span>
                        </div>
                        <span className="text-sm text-neutral-500">{getDate(post.publishedAt)}</span>
                    </div>
                </div>

                <ul className="hidden sm:flex gap-2">
                    <li>
                        <svg className="fill-neutral-400 hover:fill-neutral-800 cursor-pointer" width="24" height="24" viewBox="0 0 24 24">
